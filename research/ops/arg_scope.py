...
"""Contains the arg_scope used for scoping layers arguments.
  ...
  Example of how to use research.arg_scope:

  ```
  from research import layers

  arg_scope = research.arg_scope
  ...
  Example of how to use research.add_arg_scope to enable your
  function to be called within an arg_scope later:

  @research.add_arg_scope
